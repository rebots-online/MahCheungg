...
if not LEMONSQUEEZY_API_KEY:
    logger.warning("LEMONSQUEEZY_API_KEY not set. Some functionality may be limited.")

# Create FastAPI app
app = FastAPI(title="LemonSqueezy MCP Server")
...
def start():
    """Start the server."""
    uvicorn.run("mcp_lemonsqueezy.server:app", host="0.0.0.0", port=8000, reload=True)
