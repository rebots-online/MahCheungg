...
interface GameHubProps {
  onStartGame: (playerName: string, playerCount: number, aiDifficulty: AIDifficulty, mode?: string) => void;
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg"
              ...
              <div className="p-6 flex flex-col items-center">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 rounded-lg font-bold text-lg transition-all hover:scale-105 hover:shadow-lg"
                  style={{
                    backgroundColor: isDeepSite ? '#4a2545' : 'var(--primary-button, #3b82f6)',
                    color: isDeepSite ? '#ffc107' : '#ffffff',
            ...
            <div className="rounded-lg overflow-hidden shadow-lg"
              ...
              <div className="p-6 flex flex-col items-center">
                ...
                <p className="text-center mb-4"
                   style={{ color: isDeepSite ? '#cbd5e1' : 'var(--text-secondary, #4b5563)' }}>
                  Learn Cantonese Mahjong rules, strategies, and terminology in our comprehensive learning center.
                </p>
                <button
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div className="rounded-lg p-4 flex flex-col items-center"
                  ...
                  <button
                    ...
                    className="w-full py-2 px-3 rounded-lg text-sm font-bold transition-all hover:scale-105 hover:shadow-md"
                    style={{
                      backgroundColor: isDeepSite ? '#4a2545' : 'var(--primary-button, #3b82f6)',
                      color: isDeepSite ? '#ffc107' : '#ffffff',
                      border: isDeepSite ? '2px solid #ffc107' : 'none',
